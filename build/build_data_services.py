...
for service_type, service_descriptors in list(SERVICES_PAYLOAD.items()):
    ...
    data_services_infrastructure += service_infrastructure_code_str + "\n\n"


infrastructure_template = open(PLATFORM_INSTANCE_INFRASTRUCTURE_SOURCE_PATH, "r").read()
infrastructure_template = infrastructure_template.replace("{data_services_infrastructure}",
                                                          "{}".format(data_services_infrastructure))
